...
> Voir
> [`dev/BRIEF.md`](https://pobsteta.github.io/dessertR/dev/BRIEF.md)
> pour la conception d’ensemble et la feuille de route.
...
- **mesurer** ce que la BD TOPO ne dit pas : largeur roulable, fosses,
  devers, pente longitudinale, rayons de courbure, gabarit libre sous
  branches ;
- **qualifier la praticabilite**, en particulier l’aptitude au grumier,
  avec le motif d’inaptitude et sa localisation ;
- **diagnostiquer l’etat** en separant le signal geomorphologique
  ...
  surface (l’emprise est-elle encore degagee). C’est la divergence entre
  les deux qui revele les troncons abandonnes ou recolonises ;
...
- **Lidar HD** (IGN, licence ouverte Etalab) : nuage de points classe en
  11 categories, MNT et MNH au pas de 50 cm, dalles de 1 km x 1 km.
